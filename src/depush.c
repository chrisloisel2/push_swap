...
/*   Updated: 2021/08/26 07:46:55 by lchristo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../swap.h"

int	ft_smart_depupush(t_lst *s, t_stack *r)
{
	if (r->lenb > 0 && r->swap == 0
		&& r->b[r->lenb - 1] == next(r, r->b[r->lenb - 1]))
	{
		r->swap = r->b[r->lenb - 1];
		return (pa(r));
	}
